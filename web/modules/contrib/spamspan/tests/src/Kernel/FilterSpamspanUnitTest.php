...
class FilterSpamspanUnitTest extends KernelTestBase {
   ...
   * @var array
   */
  public static $modules = ['system', 'filter', 'spamspan'];
  ...
  protected function setUp() {
    ...
    $configuration['settings'] = ['spamspan_use_form' => 0, 'spamspan_use_graphic' => 1, 'spamspan_dot_enable' => 1] + $configuration['settings'];
